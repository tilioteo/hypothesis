...
import com.tilioteo.hypothesis.data.model.TableConstants;
...
public class TestService implements Serializable {
	...
	public static TestService newInstance() {
		return new TestService(new HibernateDao<SimpleTest, Long>(SimpleTest.class), new HibernateDao<Event, Long>(Event.class),
				new HibernateDao<SlideOrder, Long>(SlideOrder.class));
	}
	
	protected TestService(HibernateDao<SimpleTest, Long> testDao, HibernateDao<Event, Long> eventDao, HibernateDao<SlideOrder, Long> slideOrderDao) {
