...
public class UserManagementVNPresenter extends AbstractManagementPresenter implements ColumnGenerator {
    ...
    public void init() {
        ...
        userWindowPresenter = new UserWindowVNPresenter();
    }
    ...
    public Component buildTable() {
        ...
        table.addValueChangeListener((ValueChangeListener) event -> getBus().post(new MainUIEvent.UserSelectionChangedEvent()));
