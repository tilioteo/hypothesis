...
import static org.hypothesis.business.data.TestState.UNINITIALIZED;
...
public class TestStateData {
    ...
    public synchronized TestState getState() {
        return state;
    }

    public synchronized void setState(TestState state) {
        this.state = state;
    }
    ...
    public synchronized void setTestId(Long testId) {
        this.testId = testId;
    }
