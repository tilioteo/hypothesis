...
public class ScoreExportDataBuilder {
    ...
    public static Workbook exportScoresToExcelFile(
            final List<ExportScore> scores, final File file, final Consumer<Float> progressConsumer) throws IOException {
        ...
        if (scores != null && file != null) {
            ...
            for (ExportScore score : scores) {
                ...
                String dateOfBirth = score.getBirthDate() != null ? DateFormatUtils.format(score.getBirthDate(),
