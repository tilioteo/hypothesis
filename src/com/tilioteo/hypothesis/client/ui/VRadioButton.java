 ...
 * 
 */
public class VRadioButton extends FocusWidget implements	ClickHandler, HasValue<Boolean> {
	...
	public void onBrowserEvent(Event event) {
		...
		case Event.ONCLICK:
	        ...
	        ValueChangeEvent.fireIfNotEqual(VRadioButton.this, oldValue, getValue());
	        return;
