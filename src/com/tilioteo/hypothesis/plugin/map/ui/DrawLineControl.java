...
public class DrawLineControl extends org.vaadin.maps.ui.control.DrawLineControl implements SlideComponent {
	...
	protected void setProperties(Element element) {
		...
		if (utility != null) {
			...
			// set DrawLineControl specific properties
			utility.setDrawLineControlProperties(this, element, properties, slideFascia);
		}
	}
	...
	private void setDrawHandler(final String actionId) {
		addDrawFeatureListener(new FeatureHandler.DrawFeatureListener() {
			...
			public void drawFeature(DrawFeatureEvent event) {
				DrawLineControlData data = new DrawLineControlData(DrawLineControl.this, slideFascia);
				data.setFeature(event.getFeature());

				Command componentEvent = MapComponentFactory.createDrawLineControlEventCommand(data,
