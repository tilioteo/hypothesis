...
public class MessageXmlUtility {
	...
	public static boolean isValidMessageXml(Document doc) {
		return (doc != null && doc.getRootElement() != null && doc
				.getRootElement().getName().equals(MessageXmlConstants.MESSAGE));
	}
	...
	public static List<Element> getPropertyElements(Element documentRoot) {
		if (documentRoot != null) {
			...
			List<Element> properties = documentRoot.selectNodes(String.format(
					"%s//%s", MessageXmlConstants.PROPERTIES,
					MessageXmlConstants.PROPERTY));
