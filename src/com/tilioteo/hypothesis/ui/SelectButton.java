...
public abstract class SelectButton extends AbstractField<Boolean> {
	...
	/**
	 * Creates a new select button. The value of the select button is false and it
	...
	protected void fireClick() {
		fireEvent(new SelectButton.ClickEvent(this));
	}
	...
	protected void fireClick(MouseEventDetails details) {
		fireEvent(new SelectButton.ClickEvent(this, details));
	}
	...
	/**
	 * Makes it possible to invoke a click on this select button by pressing the given
	...
	public static class ClickShortcut extends ShortcutListener {
		...
		/**
		 * Creates a keyboard shortcut for clicking the given select button using the
