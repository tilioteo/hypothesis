...
public abstract class AbstractSingleComponentContainer<C extends Component> extends AbstractComponent implements SingleComponentContainer<C> {
     ...
     * {@link #setContent(C)} method after the component has been set as
     * the content.
     * 
     * @param component
     ...
     * {@link #setContent(C)} method after the content component has
    ...
    public static <C extends Component> void removeFromParent(C content)
