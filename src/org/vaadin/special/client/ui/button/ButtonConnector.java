 ...
 * 
 */
package org.vaadin.special.client.ui.button;
...
@Connect(value = org.vaadin.special.ui.Button.class, loadStyle = LoadStyle.EAGER)
    ...
    public void onClick(ClickEvent event) {
        ...
        MouseEventDetails details = MouseEventDetailsBuilder
                .buildMouseEventDetails(event.getNativeEvent(), getWidget()
                        .getElement());
        getRpcProxy(ButtonServerRpc.class).click(timestamp, details);
