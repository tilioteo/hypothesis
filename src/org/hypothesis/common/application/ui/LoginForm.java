 ...
 * the License.
 * 
 * This is edited code from original Vaadin LoginForm class
 */
 ...
 * 
 *         Application login form based on vaadin examples
 * 
 */
...
public class LoginForm extends CustomComponent {
	 ...
	 * with javascript.
	 * 
	 * Edited for Hypothesis applications
	 * 
	...
	protected byte[] getLoginHTML() {
		...
		return ("<!DOCTYPE html PUBLIC \"-//W3C//DTD "
				...
				+ "document.forms[0].action = uri;document.forms[0]."
				+ usernameInput
				+ ".focus();};"
				+ ""
				...
				+ usernameCaption
				+ "</div><div >"
				+ "<input class='v-textfield' style='display:block;' type='text' name='"
				+ usernameInput
				+ "'></div>"
				+ "<div>"
				+ passwordCaption
				+ "</div>"
				+ "<div><input class='v-textfield' style='display:block;' type='password' name='"
				+ passwordInput
				+ "'></div>"
	...
	private ParameterHandler getParamHandler() {
		return new ParameterHandler() {

			public void handleParameters(Map<String, String[]> parameters) {
				if (parameters.containsKey(usernameInput)) {
	...
	/**
	 * Returns the name of the user name input field.
	 * 
	 * @return String
	 */
	...
	/**
	 * Sets the name for password input field
	 * 
	 * @param passwordInput
	 */
	...
	/**
	 * Sets the name for user name input field
	 * 
	 * @param usernameInput
	 */
