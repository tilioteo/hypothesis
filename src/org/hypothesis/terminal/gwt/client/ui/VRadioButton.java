 ...
 * 
 */
public class VRadioButton extends FocusWidget implements Paintable,
	...
	protected final Element wrapper = DOM.createDiv();

	protected Element errorIndicatorElement;
	protected final Element inputElement = DOM.createInputRadio("");

	protected final Element captionElement = DOM.createLabel();
	...
	public VRadioButton() {
		...
		captionElement.setAttribute("for", inputElement.getId());
		captionElement.setAttribute("htmlFor", inputElement.getId());
	...
	public void onClick(ClickEvent event) {
		...
		if (BrowserInfo.get().isSafari()) {
			VRadioButton.this.setFocus(true);
		}
		if (disableOnClick) {
			setEnabled(false);
	...
	public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
		...
		if (uidl.hasAttribute("labelPosition"))
			labelPosition = LabelPosition.values()[uidl
					.getIntAttribute("labelPosition")];

		if (uidl.hasAttribute("labelVisible"))
			labelVisible = uidl.getBooleanAttribute("labelVisible");
