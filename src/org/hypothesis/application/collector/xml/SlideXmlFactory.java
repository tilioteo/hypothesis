...
public class SlideXmlFactory {
	...
	private static Logger logger = Logger.getLogger(SlideXmlFactory.class);
	...
	private static Document buildSlideXml(Document slideTemplate,
		...
		Document doc = Utility.createDocument();
	...
	public static Document buildSlideXml(Slide slide) {
		...
		try {
			...
			logger.error(String.format("SlideXmlFactory.getSlideXml(slide:%d)",
	...
	private static void mergeElements(Element destination, Element source) {
		...
		for (Node sourceNode : sourceNodes) {
			if (sourceNode instanceof Element) {
				Element destinationElement = (Element) Utility
