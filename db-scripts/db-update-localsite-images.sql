...
SET xml_data=s.xml_data
FROM
(SELECT uid, REPLACE(xml_data, 'http://hypothesis.cz/gallery/', 'http://192.168.53.1/~kamil/') xml_data FROM tbl_slide_template WHERE xml_data LIKE '%http://hypothesis.cz/gallery/%') s
WHERE
